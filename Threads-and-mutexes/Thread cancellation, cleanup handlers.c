...
void expel_student(studentsList_t *studentsList);
...
int main(int argc, char **argv)
{
	...
	if (studentsList.thStudents == NULL || studentsList.removed == NULL) ERR("Failed to allocate memory for 'students list'!");
